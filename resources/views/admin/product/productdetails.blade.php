            ...
            <div class="card" style="width: 65rem;">
                <div class="card-header bg-primary" style="color:#FFF;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Small_image:
                            @if(isset($details['attributes']['small_image']))
                                @if(is_array($details['attributes']['small_image']))
                                @else
                                       <img src="{{ $details['attributes']['small_image'] }}" alt="">
                                @endif
                            @endif
                        </li>
                        ...
                        <li class="list-group-item">Image: 
                            @if(isset($details['attributes']['image']))
                                @if(is_array($details['attributes']['image']))
                                @else
                                    <img src="{{$details['attributes']['image']}}" style="width:50px;" alt="">
                                @endif
                            @endif    
                        </li>
                        <li class="list-group-item">Attributes Thumbnail:
                            @if(isset($details['attributes']['thumbnail']))
                                @if(is_array($details['attributes']['thumbnail']))
                                @else
                                        <span class="badge badge-info">{{$details['attributes']['thumbnail']}}</span> 
                                @endif
                            @endif
                        </li>
