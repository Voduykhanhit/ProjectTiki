...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
       @include('admin.layout.header')
        ...
        <script src="{{asset('public/admin_asset/js/jquery-3.5.1.slim.min.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('public/admin_asset/js/bootstrap.bundle.min.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('public/admin_asset/js/scripts.js')}}"></script>
        <script src="{{asset('public/admin_asset/js/Chart.min.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('public/admin_asset/assets/demo/chart-area-demo.js')}}"></script>
        <script src="{{asset('public/admin_asset/assets/demo/chart-bar-demo.js')}}"></script>
        <script src="{{asset('public/admin_asset/js/jquery.dataTables.min.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('public/admin_asset/js/dataTables.bootstrap4.min.js')}}" crossorigin="anonymous"></script>
        <script src="{{asset('public/admin_asset/assets/demo/datatables-demo.js')}}"></script>
        <script>
