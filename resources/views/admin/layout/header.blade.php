...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="{{url('/admin/seller/list-seller')}}"><img src="public/admin_asset/assets/img/tiki.png" style="width:150px;height:70px;" alt=""></a>
